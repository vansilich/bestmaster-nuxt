<template>
    <div class="review-card">
        <div class="review-card__wrapper">
            <img class="review-card__media" :src="require(`~/assets/img/reviews/${this.photo}`)" alt="">
            <div class="review-content review-card__left">
                <div class="inst review-content__inst">
                    ...
                    <a :href="link" class="inst__nick" target="_blank" rel="noopener">{{ inst_nickname }}</a>
                </div>
                <div class="review-text">
                    <p class="review-text__content">{{ description }}</p>
                </div>
            </div>
        </div>
    </div>
...
.inst{
    ...
    justify-content: center;
    align-items: center;
    background: linear-gradient(92.22deg, #F09433 0%, #E6683C 29.69%, #DC2743 55.21%, #CC2366 78.65%, #BC1888 100%);
